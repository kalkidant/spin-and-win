(function(){
    ...
    ZAPNET.Events = function(){
        ...
        connect = function(request){
            ...
            currentConnection = YAHOO.util.Connect.asyncRequest(request.method, request.cb, request.data);
        },

        batchConnect = function(type, method, cb, data){
        ...
        action = function(data, onerror){
            ...
            batchConnect('action', 'POST', cb, data);
        },
